...
# class that defines and loads the Rest dataset
...
model.load_weights('C:\Program Files (x86)\Microsoft Visual Studio\Shared\Python37_64\Mask_RCNN-master\mask_rcnn_coco.h5', by_name=True,
